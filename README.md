...
**[Rails blog_app]** > A Blog app will be a classic example of a blog website. User will be able create a fully functional website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

postgresql - Rails - React-js
...
```sh
  cd my-folder
  git@github.com:ChaabaneAnas/hello_react-front-end.git
```
